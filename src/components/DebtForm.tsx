...
import { addDebtAction, type ActionState } from "@/app/actions";

const initialState: ActionState = {};

export function DebtForm() {
  const [state, formAction, pending] = useActionState(addDebtAction, initialState);
